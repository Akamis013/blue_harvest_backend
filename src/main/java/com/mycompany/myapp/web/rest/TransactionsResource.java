...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Transactions}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransactionsResource {
    ...
    public TransactionsResource(TransactionsRepository transactionsRepository, TransactionsSearchRepository transactionsSearchRepository) {
    ...
    public ResponseEntity<Transactions> createTransactions(@RequestBody Transactions transactions) throws URISyntaxException {
        ...
        transactionsSearchRepository.save(result);
    ...
    /**
     * {@code SEARCH  /_search/transactions?query=:query} : search for the transactions corresponding
     * to the query.
     *
    ...
    public List<Transactions> searchTransactions(@RequestParam String query) {
