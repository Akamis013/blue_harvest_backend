...
@RestController
@RequestMapping("/api/blue-harvest-backend-kafka")
public class BlueHarvestBackendKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BlueHarvestBackendKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BlueHarvestBackendKafkaResource(KafkaProperties kafkaProperties) {
